...
from test_live_base import LiveTestCase, get_clltk_path, live_process, run_live_with_timeout
...
class TestLiveRealTimeOutput(LiveTestCase):
    ...
    def test_existing_tracepoints_appear_before_sigint(self):
        ...
        result = run_live_with_timeout(self.trace_path, timeout_seconds=1,
