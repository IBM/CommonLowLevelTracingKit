...
inline int64_t TimeSpec::parse_duration_ns(std::string_view input)
{
	if (input.empty())
...
inline uint64_t TimeSpec::parse_float_seconds_ns(std::string_view input)
{
	try {
...
inline uint64_t TimeSpec::parse_datetime_ns(std::string_view input)
{
	// Supported formats:
	// "2025-11-25T21:46:29"
	// "2025-11-25 21:46:29"
...
inline TimeSpec TimeSpec::parse(std::string_view input)
{
	TimeSpec result;
...
inline uint64_t TimeSpec::resolve(uint64_t now_ns, uint64_t min_ns, uint64_t max_ns) const
{
	int64_t base_ns = 0;
